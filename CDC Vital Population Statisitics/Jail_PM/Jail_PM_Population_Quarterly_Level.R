        ...
        for (pop in pop_cat_list) { 
          ...
          # We are just going to calculate for all_pop in this loop
            ...
            # get population for site and year
              ...
              cat("Booking", current_site, current_year, current_quarter, race, pop, sub, "\n", " ")
        ...
        for (pop in pop_cat_list) {
          ...
          for (sub in sub_pop_list) {
            ...
            if ((dim(current_df_ADP_admrel)[1] == 0)) {
              ...
              cat("ADP admrel", current_site, current_year, current_quarter, race, pop, sub, "\n", " ")
              current_year_in_loop <- current_year # initialize to year in loop...might need to be changed within the loop
        ...
        for (pop in pop_cat_list) {
          ...
          for (sub in sub_pop_list) {
            ...
            if (dim(current_df_ADP_snapshot)[1] == 0) {
              ...
              cat("ADP Snapshots", current_site, current_year, current_quarter, race, pop, sub, "\n", " ")
              current_year_in_loop <- current_year # initialize to year in loop...might need to be changed within the loop
        ...
        for (pop in pop_cat_list) {
          ...
          for (sub in sub_pop_list) {
            ...
            if (dim(current_df_ALOS_rel)[1] == 0 | dim(white_df_ALOS_rel)[1] == 0) {
              ...
              cat("ALOS rel", current_site, current_quarter, race, current_year, pop, sub, "\n", " ")
              current_year_in_loop <- current_year # initialize to year in loop...might need to be changed within the loop
